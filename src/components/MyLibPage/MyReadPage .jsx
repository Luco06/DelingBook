...
import { MyLibraryReadState, BookDetailsState, User } from "../../recoil";
import { useRecoilValue, useSetRecoilState } from "recoil";
import { useNavigation } from "@react-navigation/native";

export default function MyReadPage({ navigation: { goBack } }) {
  ...
  console.log("MyLib", MyLibraryRead);
  return (
    <View style={styles.container}>
      ...
      <TitlePage>En cours</TitlePage>
      <ScrollView style={styles.contentContainer}>
        <ViewLike>
          {MyLibraryRead.map((item) => {
            return (
              <ViewChoiceBook key={item._id}>
                ...
                <View style={styles.shadow}>
                  <TouchableOpacity
                    onPress={() => (
                      setDetailsBook(item),
                      navigation.navigate("BookDetailRead")
                    )}
                  >
                    <ImgChoiceBook
                      source={{
