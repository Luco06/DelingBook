...
export const userLogin = (payload) => {
  return fetch("http://192.168.1.44:3000/login", {
    method: "POST",
    headers: {
...
export const logoutUser = (token) => {
  return new Promise((resolve, reject) => {
    fetch("http://192.168.1.44:3000/logout", {
      method: "POST",
      headers: {
        Authorization: token,
      },
...
export const createUser = (payload) => {
  return fetch("http://192.168.1.44:3000/users", {
    method: "POST",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const updateUser = (payload, token) => {
  return fetch("http://192.168.1.44:3000/users/me", {
    method: "PATCH",
    headers: {
...
export const searchUser = (payload, token) => {
  return fetch("http://192.168.1.44:3000/users/searchuser", {
    method: "POST",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const addUser = (payload, token) => {
  return fetch("http://192.168.1.44:3000/users/addfriend", {
    method: "POST",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const getFriendList = async (userId, token) => {
  return fetch(`http://192.168.1.44:3000/users/${userId}/friends`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const deleteFriend = (userId, friendId, token) => {
  return fetch(
    `http://192.168.1.44:3000/users/deletefriend/${userId}/${friendId}`,
    {
      method: "DELETE",
      headers: {
        "Content-type": "application/json",
...
export const deletePost = (publicationId, token) => {
  return fetch(`http://192.168.1.44:3000/publications/${publicationId}`, {
    method: "DELETE",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const addBook = (userId, payload, token) => {
  return fetch(`http://192.168.1.44:3000/addBook/${userId}`, {
    method: "POST",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const getBookInMyLibrary = (userId, tag, token) => {
  return fetch(`http://192.168.1.44:3000/booksByTag/${userId}/${tag}`, {
    method: "GET",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
...
export const deleteBookInMyLbrary = (userId, bookId, token) => {
  return fetch(`http://192.168.1.44:3000/deleteBook/${userId}/${bookId}`, {
    method: "DELETE",
    headers: {
      "Content-type": "application/json",
      Accept: "application/json",
